...
object HypixelPackCache {
    ...
    private fun File.pack(): Pack? {
        ...
        return try {
            Pack.readMetaAndCreate(PackLocationInfo("detexturify/fallback/hypixel", Component.literal("Detexturify: Hypixel SkyBlock (cached)"), PackSource.BUILT_IN, Optional.empty()), FilePackResources.FileResourcesSupplier(this), PackType.CLIENT_RESOURCES, PackSelectionConfig(true, Pack.Position.BOTTOM, true))
        } catch (t: Throwable) {
